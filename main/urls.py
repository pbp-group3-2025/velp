...
from main.views import edit_venue, edit_venue_ajax
...
urlpatterns = [
    ...
    path('venue/create/ajax/', create_venue_ajax, name='create_venue_ajax'),
    ...
    path('venue/<str:id>/edit', edit_venue, name='edit_venue'),
    path('venue/<str:id>/edit/ajax', edit_venue_ajax, name='edit_venue_ajax'),
    path('venue/<str:id>/delete', delete_venue, name='delete_venue'),
    path('venue/<str:id>/delete/ajax', delete_venue_ajax, name='delete_venue_ajax'),

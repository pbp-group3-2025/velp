...
urlpatterns = [
    ...
    path('venue/<int:venue_id>/json/', views.get_reviews_by_venue_json, name='get_reviews_json'),
    path('add_review_ajax/<int:venue_id>/', views.add_review_ajax_flutter, name='add_review_ajax_flutter'),
